...
export const resolveAuthConfiguration = ({ authMode, publishableKey, nodeEnv }) => {
    ...
    if (mode === 'clerk' && !publishableKey) {
        return {
            mode,
            error: 'Set VITE_CLERK_PUBLISHABLE_KEY or use VITE_AUTH_MODE=local for development.',
        };
    }
...
const localAuthToken = import.meta.env.VITE_LOCAL_AUTH_TOKEN || DEFAULT_LOCAL_AUTH_TOKEN;
const localUserId = import.meta.env.VITE_LOCAL_AUTH_USER_ID || 'local_development_user';
