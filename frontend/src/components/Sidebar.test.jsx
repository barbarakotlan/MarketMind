...
const renderSidebar = (activePage = 'dashboard') =>
    render(
        <NavigationContext.Provider value={{ activePage, setActivePage: vi.fn() }}>
...
vi.mock('../config/api', () => ({
    API_ENDPOINTS: {
        ...
        MARKETMIND_AI_CHAT_DELETE: vi.fn((chatId) => `/marketmind-ai/chats/${chatId}`),
        NOTIFICATIONS_TRIGGERED: vi.fn((all = false) =>
