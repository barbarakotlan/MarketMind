...
import QuizSection from './getting-started/QuizSection';
import ChapterContent from './getting-started/ChapterContent';
import ChapterSearch from './getting-started/ChapterSearch';
import KeyboardHelp from './getting-started/KeyboardHelp';
import useGettingStartedProgress from './getting-started/useGettingStartedProgress';
