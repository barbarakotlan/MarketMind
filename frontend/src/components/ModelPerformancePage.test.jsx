...
vi.mock('./charts/ActualVsPredictedChart', () => ({
    default: () => <div data-testid="actual-vs-predicted-chart" />,
}));

vi.mock('../config/api', () => ({
    API_ENDPOINTS: {
        EVALUATE: vi.fn((ticker, params) => `/evaluate/${ticker}?${new URLSearchParams(params).toString()}`),
    },
    apiRequest: vi.fn(),
}));
