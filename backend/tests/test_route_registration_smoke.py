...
class RouteRegistrationSmokeTests(unittest.TestCase):
    def test_expected_routes_still_exist(self):
        ...
        expected = {
            ...
            "/api/public/v2/search-symbols": {"GET"},
            "/api/public/v2/stock/<string:ticker>": {"GET"},
            "/api/public/v2/chart/<string:ticker>": {"GET"},
            "/api/public/v2/fundamentals/<string:ticker>": {"GET"},
            "/api/public/v2/macro/overview": {"GET"},
            "/api/public/v2/predictions/ensemble/<string:ticker>": {"GET"},
            "/api/public/v2/evaluations/<string:ticker>": {"GET"},
            "/api/public/v2/screener/presets": {"GET"},
            "/api/public/v2/screener/scan": {"GET"},
